...
function highlightName(element){
 ...
 const foundObject = restaurants.find(({ name }) => name === element.parentNode.children[0].innerText);
...
restaurants.forEach(element => {
  table.insertAdjacentHTML('beforeend', `<tr><th onClick= "highlightName(this)">${element.name}</th><th>${element.address}</th></tr>`);
});